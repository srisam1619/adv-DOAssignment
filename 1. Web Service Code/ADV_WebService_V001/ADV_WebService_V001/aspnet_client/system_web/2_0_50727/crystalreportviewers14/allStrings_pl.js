...
var L_bobj_crv_Back = "Wstecz";
var L_bobj_crv_Forward = "Dalej";
var L_bobj_crv_Page = "Strona";
var L_bobj_crv_PageNum = "Strona {0}";
...
var L_bobj_crv_InvalidPageNumber = "Podaj numer strony wi\u0119kszy ni\u017C 0.";
var L_bobj_crv_ParamPanel = "Panel monitu";
var L_bobj_crv_Parameters = "Parametry";
var L_bobj_crv_GroupTree = "Drzewo grup";
var L_bobj_crv_Search = "Znajd\u017A";
var L_bobj_crv_SearchResults = "Wyniki znajdowania";
var L_bobj_crv_DrillUp = "Agreguj";
var L_bobj_crv_DrillTo = "Dr\u0105\u017C do %1";
...
var L_bobj_crv_SearchText = "Znajd\u017A";
var L_bobj_crv_SearchOptions = "Opcje znajdowania";
var L_bobj_crv_Export = "Eksportuj ten raport";
var L_bobj_crv_Print = "Drukuj ten raport";
var L_bobj_crv_History = "Historia";
var L_bobj_crv_ClearHistory = "Wyczy\u015B\u0107 histori\u0119";
var L_bobj_crv_TabList = "Lista kart";
var L_bobj_crv_Minimize = "Minimalizuj";
var L_bobj_crv_Logo=  "Logo Business Objects";
var L_bobj_crv_FileMenu = "Menu Plik";
var L_bobj_crv_ResultsFound = "Liczba znalezionych wynik\u00F3w: {0}";
var L_bobj_crv_MatchWholeWordsOnly = "Tylko ca\u0142e wyrazy";
var L_bobj_crv_MatchCase = "Uwzgl\u0119dniaj wielko\u015B\u0107 liter";
var L_bobj_crv_FindMore = "Znajd\u017A wi\u0119cej";
var L_bobj_crv_Completed = "Zako\u0144czono";
var L_bobj_crv_Breadcrumb= "\u015Acie\u017Cka nawigacyjna";
...
var L_bobj_crv_ParamsApplyTip = "Zastosuj warto\u015Bci parametr\u00F3w";
var L_bobj_crv_ParamsDlgTitle = "Wprowad\u017A warto\u015Bci";
var L_bobj_crv_ParamsCalBtn = "Kalendarz";
var L_bobj_crv_Reset= "Resetuj";
var L_bobj_crv_ResetTip = "Resetuj warto\u015Bci parametr\u00F3w";
...
var L_bobj_crv_ParamsBadDate = "Ten parametr jest typu \"Data\" i powinien mie\u0107 format \"%1\", gdzie \"rrrr\" to rok w formacie czterocyfrowym, \"mm\" \u2014 miesi\u0105c (np. stycze\u0144 = 1), a \"dd\" \u2014 dzie\u0144 miesi\u0105ca.";
...
var L_bobj_crv_ParamsBadDateTime = "Ten parametr jest typu \"Data/godzina\" i jego poprawny format to \"%1 gg:mm:ss\". \"rrrr\" to rok w formacie czterocyfrowym, \"mm\" \u2014 miesi\u0105c (np. stycze\u0144 = 1), \"dd\" \u2014 dzie\u0144 miesi\u0105ca, \"gg\" \u2014 godziny wg zegara 24-godzinnego, \"mm\" \u2014 minuty, a \"ss\" \u2014 sekundy.";
...
var L_bobj_crv_FlashRequired = "Ta zawarto\u015B\u0107 wymaga programu Adobe Flash Player 11 lub nowszego. {0}Kliknij tutaj, aby go zainstalowa\u0107.";
...
var L_bobj_crv_LastRefreshed = "Ostatnie od\u015Bwie\u017Cenie: {0}";

var L_bobj_crv_Collapse = "Zwi\u0144";

var L_bobj_crv_CatalystTip = "Zasoby online";
var L_bobj_crv_LoadingPage = "Trwa \u0142adowanie strony {0}...";
var L_bobj_crv_TakeActionMenuTip = "Wybierz powi\u0105zan\u0105 czynno\u015B\u0107";
var L_bobj_crv_TakeActionExecuteActionError = "Podczas wykonywania czynno\u015Bci wyst\u0105pi\u0142 problem. Skontaktuj si\u0119 z Administratorem.";
...
var L_bobj_crv_TakeActionNoActionsMenuLabel = "(Brak dost\u0119pnych czynno\u015Bci)";

var L_bobj_crv_API_InvalidArray = "Zmienna \'{0}\' ma typ tablicowy";
var L_bobj_crv_API_InvalidBoolean = "Zmienna \'{0}\' ma typ logiczny";
var L_bobj_crv_API_InvalidPageNumber = "Warto\u015B\u0107 \u201EpageNumber\u201D jest liczb\u0105 ca\u0142kowit\u0105 wi\u0119ksz\u0105 ni\u017C zero 0";
var L_bobj_crv_API_InstantiationFailed = "Nale\u017Cy utworzy\u0107 nowe wyst\u0105pienie obiektu {0}.";
var L_bobj_crv_API_InvalidParamValue = "Warto\u015B\u0107 pola parametru \u201E{0}\u201D jest nieprawid\u0142owa.";
var L_bobj_crv_API_InvalidParamType = "Typ pola parametru \u201E{0}\u201D jest nieprawid\u0142owy. Wybierz prawid\u0142owy typ spo\u015Br\u00F3d typ\u00F3w danych SAP.CR.Parameter.DataTypes";
var L_bobj_crv_API_InvalidParamName = "Nazwa pola parametru musi by\u0107 ci\u0105giem znaku o d\u0142ugo\u015Bci wi\u0119kszej ni\u017C 0.";

var L_bobj_crv_API_InvalidNumOfArguments = "{0} wymaga {1} argument\u00F3w.";
var L_bobj_crv_API_InvalidValueType = "Oczekiwanym typem warto\u015Bci tego parametru jest \u201E{0}\u201D.";
var L_bobj_crv_API_InvalidCanvasListener= "Odbiornik musi by\u0107 wyst\u0105pieniem klasy SAP.CR.Viewer.CanvasListener";
var L_bobj_crv_API_InvalidActionListener= "Odbiornik musi by\u0107 wyst\u0105pieniem klasy SAP.CR.Viewer.ActionListener";
var L_bobj_crv_API_ValueTypeUndefined= "W\u0142a\u015Bciwo\u015B\u0107 paramType pola parametru jest nieprawid\u0142owa. Obs\u0142ugiwane s\u0105 tylko warto\u015Bci ze \u015Bcie\u017Cki SAP.CR.Parameter.DataTypes.*.";
var L_bobj_crv_API_InvalidRangeBound = "Ograniczenie g\u00F3rne i dolne mo\u017Ce przyjmowa\u0107 tylko warto\u015Bci z zakresu SAP.CR.Parameter.RangeBoundTypes";
var L_bobj_crv_API_InvalidBeginValue = "Warto\u015B\u0107 pocz\u0105tkowa jest nieprawid\u0142owa";
var L_bobj_crv_API_InvalidEndValue = "Warto\u015B\u0107 ko\u0144cowa jest nieprawid\u0142owa";
var L_bobj_crv_API_RangeBeginValueGreaterThanEndValue = "Warto\u015B\u0107 pocz\u0105tkowa nie mo\u017Ce przekracza\u0107 warto\u015Bci ko\u0144cowej";
var L_bobj_crv_API_InvalidLowerAndUpperRangeBound = "Ograniczenie g\u00F3rne i dolne nie mog\u0105 jednocze\u015Bnie mie\u0107 warto\u015Bci SAP.CR.Parameter.DataTypes.UNBOUNDED";
var L_bobj_crv_API_InvalidBeginAndEndValue = "Warto\u015B\u0107 pocz\u0105tkowa nie mo\u017Ce by\u0107 r\u00F3wna warto\u015Bci ko\u0144cowej.";
var L_bobj_crv_API_InvalidColor = "Kolor \u201E{0}\u201D jest nieprawid\u0142owy.";
var L_bobj_crv_API_InvalidResolution = "Rozdzielczo\u015B\u0107 {0} jest nieprawid\u0142owa";
var L_bobj_crv_API_InvalidEventName = "\u201E{0}\u201D nie jest prawid\u0142owym zdarzeniem. Wybierz zdarzenie z {1}";
var L_bobj_crv_API_InvalidViewerName = "Nazwa przegl\u0105darki \'{0}\' jest \u017Ale sformu\u0142owana. Musi zaczyna\u0107 si\u0119 od litery, a za ni\u0105 mo\u017Ce wyst\u0119powa\u0107 dowolna liczba liter lub cyfr.";
var L_bobj_crv_API_ViewerInitFailed = "Nie powiod\u0142a si\u0119 pr\u00F3ba zainicjowania przegl\u0105darki";
var L_bobj_crv_API_ViewerLoadFailed = "Nie powiod\u0142a si\u0119 pr\u00F3ba za\u0142adowania przegl\u0105darki";

var L_bobj_crv_API_InvalidPrintMode = "\u201E{0}\u201D nie jest prawid\u0142owym trybem drukowania. Wybierz tryb drukowania z {1}";
var L_bobj_crv_API_InvalidReportMode = "\u201E{0}\u201D nie jest prawid\u0142owym trybem raportu. Wybierz tryb raportu spo\u015Br\u00F3d: {1}";
var L_bobj_crv_API_InvalidZoom = "\u201E{0}\u201D nie jest prawid\u0142owym powi\u0119kszeniem";
var L_bobj_crv_API_InvalidFunction = "Pierwszy argument powinien by\u0107 funkcj\u0105";
var L_bobj_crv_API_InvalidFunctionAfterInit = "Po zainicjowaniu przegl\u0105darki nie mo\u017Cna wywo\u0142a\u0107 funkcji \'{0}\'.";
// <script>
/*
=============================================================
...
L_DHTMLLIB_month[0]="Styczeń";
L_DHTMLLIB_month[1]="Luty";
L_DHTMLLIB_month[2]="Marzec";
L_DHTMLLIB_month[3]="Kwiecień";
L_DHTMLLIB_month[4]="Maj";
L_DHTMLLIB_month[5]="Czerwiec";
L_DHTMLLIB_month[6]="Lipiec";
L_DHTMLLIB_month[7]="Sierpień";
L_DHTMLLIB_month[8]="Wrzesień";
L_DHTMLLIB_month[9]="Październik";
L_DHTMLLIB_month[10]="Listopad";
L_DHTMLLIB_month[11]="Grudzień";

L_DHTMLLIB_closeDialog="Zamknij okno";

L_DHTMLLIB_openMenu="Kliknij tutaj, aby uzyskać dostęp do opcji {0}";

L_DHTMLLIB_expandedLab="Rozwinięty";
L_DHTMLLIB_collapsedLab="Zwinięty";
L_DHTMLLIB_selectedLab="Wybrane";

L_DHTMLLIB_calendarNextMonthLab="Przejdź do następnego miesiąca";
L_DHTMLLIB_calendarPrevMonthLab="Przejdź do poprzedniego miesiąca";
L_DHTMLLIB_calendarNextYearLab="Przejdź do następnego roku";
L_DHTMLLIB_calendarPrevYearLab="Przejdź do poprzedniego roku";
L_DHTMLLIB_calendarSelectionLab="Wybrany dzień";

L_DHTMLLIB_menuCheckLab="Zaznaczone";
L_DHTMLLIB_menuDisableLab="Wyłączone";
	
L_DHTMLLIB_level="Poziom";
L_DHTMLLIB_closeTab="Zamknij kartę";
L_DHTMLLIB_of=" z ";

L_DHTMLLIB_helpLab="Pomoc";

L_DHTMLLIB_cancelButtonLab="Anuluj";
