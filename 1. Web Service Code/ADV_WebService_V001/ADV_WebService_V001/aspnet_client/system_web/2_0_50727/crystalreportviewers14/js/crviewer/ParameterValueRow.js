    ...
    */
    ...
    refreshWarningPopup : function() {
        if (this._warning) {
            ...
            var rightOffset = -leftOffset + this.getWidth() - 270;
            var topOffset = 33;
            bobj.crv.WarningPopup.getInstance ().show (this._warning.message, pos.x + (bobj.crv.config.isRTL? rightOffset:leftOffset), pos.y + topOffset);
        } else {
     ...
     */
    _onKeyUp : function(e) {
        var event = new MochiKit.Signal.Event (null, e);
