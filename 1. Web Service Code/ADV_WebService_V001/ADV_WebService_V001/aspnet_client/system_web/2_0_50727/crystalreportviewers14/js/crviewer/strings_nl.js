...
var L_bobj_crv_Back = "Terug";
var L_bobj_crv_Forward = "Vooruit";
...
var L_bobj_crv_InvalidPageNumber = "Geef een paginanummer hoger dan 0 op.";
var L_bobj_crv_ParamPanel = "Aanwijzingsvenster";
var L_bobj_crv_Parameters = "Parameters";
var L_bobj_crv_GroupTree = "Groepsstructuur";
var L_bobj_crv_Search = "Zoeken";
var L_bobj_crv_SearchResults = "Zoekresultaten";
var L_bobj_crv_DrillUp = "Analyse op hoger niveau";
var L_bobj_crv_DrillTo = "Analyseren tot %1";
...
var L_bobj_crv_SearchText = "Zoeken";
var L_bobj_crv_SearchOptions = "Zoekopties";
var L_bobj_crv_Export = "Dit rapport exporteren";
var L_bobj_crv_Print = "Dit rapport afdrukken";
var L_bobj_crv_History = "Geschiedenis";
var L_bobj_crv_ClearHistory = "Geschiedenis wissen";
var L_bobj_crv_TabList = "Tablijst";
var L_bobj_crv_Minimize = "Minimaliseren";
var L_bobj_crv_Logo=  "Business Objects-logo";
var L_bobj_crv_FileMenu = "het menu Bestand";
var L_bobj_crv_ResultsFound = "{0} resultaten gevonden";
var L_bobj_crv_MatchWholeWordsOnly = "Heel woord";
var L_bobj_crv_MatchCase = "Identieke hoofdletters/kleine letters";
var L_bobj_crv_FindMore = "Meer informatie";
var L_bobj_crv_Completed = "Voltooid";
...
var L_bobj_crv_ParamsApplyTip = "Parameterwaarden toepassen";
var L_bobj_crv_ParamsDlgTitle = "Waarden invoeren";
var L_bobj_crv_ParamsCalBtn = "Agenda";
var L_bobj_crv_Reset= "Opnieuw instellen";
var L_bobj_crv_ResetTip = "Parameterwaarden herstellen";
...
var L_bobj_crv_FlashRequired = "Voor deze inhoud hebt u Adobe Flash Player 11 of later nodig. {0}Klik hier om het programma te installeren.";
...
var L_bobj_crv_LastRefreshed = "Laatst vernieuwd: {0}";

var L_bobj_crv_Collapse = "Samenvouwen";

var L_bobj_crv_CatalystTip = "Onlinebronnen";
var L_bobj_crv_LoadingPage = "Pagina {0} laden...";
var L_bobj_crv_TakeActionMenuTip = "Een gebonden actie selecteren";
var L_bobj_crv_TakeActionExecuteActionError = "Er is een probleem opgetreden tijdens uitvoering van actie; neem contact op met uw beheerder.";
...
var L_bobj_crv_TakeActionNoActionsMenuLabel = "(Geen acties beschikbaar)";

var L_bobj_crv_API_InvalidArray = "\'{0}\' is van het type matrix";
var L_bobj_crv_API_InvalidBoolean = "\'{0}\' is van het type Boolean";
var L_bobj_crv_API_InvalidPageNumber = "\'pageNumber\' is van het type geheel getal en is groter dan 0";
var L_bobj_crv_API_InstantiationFailed = "Er moet een nieuw exemplaar van {0} worden gemaakt.";
var L_bobj_crv_API_InvalidParamValue = "De waarde van parameterveld \'{0}\' is ongeldig.";
var L_bobj_crv_API_InvalidParamType = "Het type parameterveld \'{0}\' is ongeldig. Kies een geldig type uit SAP.CR.Parameter.DataTypes";
var L_bobj_crv_API_InvalidParamName = "De naam van het parameterveld moet een tekenreeks langer dan 0 zijn.";

var L_bobj_crv_API_InvalidNumOfArguments = "{0} vereist {1} argument(en).";
var L_bobj_crv_API_InvalidValueType = "Verwacht waardetype voor deze parameter is \'{0}\'.";
var L_bobj_crv_API_InvalidCanvasListener= "Listener moet een exemplaar van SAP.CR.Viewer.CanvasListener zijn";
var L_bobj_crv_API_InvalidActionListener= "Listener moet een exemplaar van SAP.CR.Viewer.ActionListener zijn";
var L_bobj_crv_API_ValueTypeUndefined= "De eigenschap paramType van het parameterveld is niet geldig. Alleen waarden van SAP.CR.Parameter.DataTypes.* worden ondersteund.";
var L_bobj_crv_API_InvalidRangeBound = "Voor de bovengrens en ondergrens kunnen alleen waarden van SAP.CR.Parameter.RangeBoundTypes worden gebruikt";
var L_bobj_crv_API_InvalidBeginValue = "De beginwaarde is niet geldig";
var L_bobj_crv_API_InvalidEndValue = "De eindwaarde is niet geldig";
var L_bobj_crv_API_RangeBeginValueGreaterThanEndValue = "De beginwaarde moet minder zijn dan of gelijk zijn aan de eindwaarde";
var L_bobj_crv_API_InvalidLowerAndUpperRangeBound = "De waarde van ondergrens en bovengrens mag niet gelijk zijn aan SAP.CR.Parameter.DataTypes.UNBOUNDED";
var L_bobj_crv_API_InvalidBeginAndEndValue = "De begin- en eindwaarde mogen niet gelijk zijn.";
var L_bobj_crv_API_InvalidColor = "De kleur \'{0}\' is niet geldig.";
var L_bobj_crv_API_InvalidResolution = "De resolutie {0} is ongeldig";
var L_bobj_crv_API_InvalidEventName = "\'{0}\' is geen geldige gebeurtenis. Kies een gebeurtenis uit {1}";
var L_bobj_crv_API_InvalidViewerName = "De naam van de viewer \'{0}\' heeft een onjuiste indeling. Deze moet beginnen met een letter, die mag worden gevolgd door een willekeurig aantal letters of cijfers.";
var L_bobj_crv_API_ViewerInitFailed = "Kan viewer niet initialiseren";
var L_bobj_crv_API_ViewerLoadFailed = "Kan viewer niet laden";

var L_bobj_crv_API_InvalidPrintMode = "\'{0}\' is geen geldige afdrukmodus. Kies een afdrukmodus uit {1}";
var L_bobj_crv_API_InvalidReportMode = "\'{0}\' is geen geldige rapportmodus. Kies een rapportmodus uit {1}";
var L_bobj_crv_API_InvalidZoom = "\'{0}\' is geen geldig zoomniveau";
var L_bobj_crv_API_InvalidFunction = "Eerste argument moet een functie zijn";
var L_bobj_crv_API_InvalidFunctionAfterInit = "\'{0}\' kan niet worden aangeroepen nadat viewer is gestart.";
