...
// text				[String optional]	label
{
	...
	o.label.text=text
	if (o.showCancel) {
		o.cancelButton=newButtonWidget(id+"_cancelButton",L_DHTMLLIB_cancelButtonLab,CancelButton_cancelCB)
...
// Returns the HTML generated for the WaitDialogBoxWidget
{
    var o=this, s=''
        ...
        s+= '<table border="0" cellspacing="0" cellpadding="0" width="100%" dir='; 
        s+= bobj.crv.config.isRTL?'"RTL"':'"LTR"';
        s+= '><tbody>';
        s+= '<tr>' +
