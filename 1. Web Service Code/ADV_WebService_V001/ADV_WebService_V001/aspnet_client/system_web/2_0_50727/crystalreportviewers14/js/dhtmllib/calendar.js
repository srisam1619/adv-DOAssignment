...
// Returns       [CalendarWidget] the new instance
{
	...
	var p1=o.p1=newIconWidget(id+"_p1",_skin+'../lov.gif',CalendarWidget_clickCB,"",L_DHTMLLIB_calendarPrevMonthLab,8,4,46,12)
	var p2=o.p2=newIconWidget(id+"_p2",_skin+'../lov.gif',CalendarWidget_clickCB,"",L_DHTMLLIB_calendarPrevYearLab,8,4,46,12)
	var n1=o.n1=newIconWidget(id+"_n1",_skin+'../lov.gif',CalendarWidget_clickCB,"",L_DHTMLLIB_calendarNextMonthLab,8,4,46,0)
	var n2=o.n2=newIconWidget(id+"_n2",_skin+'../lov.gif',CalendarWidget_clickCB,"",L_DHTMLLIB_calendarNextYearLab,8,4,46,0)
...
// Returns       [CalendarMenuWidget] the new instance
{
	...
	var p1=o.p1=newIconWidget(id+"_p1",_skin+'../lov.gif',CalendarMenuWidget_clickCB,"",L_DHTMLLIB_calendarPrevMonthLab,8,4,46,12)
	var p2=o.p2=newIconWidget(id+"_p2",_skin+'../lov.gif',CalendarMenuWidget_clickCB,"",L_DHTMLLIB_calendarPrevYearLab,8,4,46,12)
	var n1=o.n1=newIconWidget(id+"_n1",_skin+'../lov.gif',CalendarMenuWidget_clickCB,"",L_DHTMLLIB_calendarNextMonthLab,8,4,46,0)
	var n2=o.n2=newIconWidget(id+"_n2",_skin+'../lov.gif',CalendarMenuWidget_clickCB,"",L_DHTMLLIB_calendarNextYearLab,8,4,46,0)
	...
	for (var i=0;i<42;i++)
	{
		...
		else
		{
			...
			if (j==o.day)
			{
				...
				lay.title=L_DHTMLLIB_calendarSelectionLab+(j+1)
			}
		}
		lay.className=cName
	}
