...
bobj.crv.PanelNavigatorItem.prototype = {
    getHTML : function() {
        ...
        return h.DIV ( {
            ...
            style : {
                ...
                'background-image' : (_ie ? 'url('+_skin+'../transp.gif)': '')
            },
            title : this._title,
            role : 'button'
    ...
    _onFocus : function () {
        MochiKit.DOM.addElementClass (this.layer, "panelNavigatorItemHighlighted");
    },
    
    _onBlur : function () {
        MochiKit.DOM.removeElementClass (this.layer, "panelNavigatorItemHighlighted");
    },
    ...
    setSelected : function(isSelected) {
        ...
        if (this.layer) {
            if (isSelected)
                DOM.addElementClass (this.layer, "panelNavigatorItemSelected");
            else
                DOM.removeElementClass (this.layer, "panelNavigatorItemSelected");
        }
    },
