...
bobj.crv.ViewerListener.prototype = {
    ...
    _onfindLastPageNumber : function () {
        ...
        this._request({'findLastPageNumber' : 1}, true, false);
    },
    ...
    _onSearchAll: function(searchText, isNewSearch, isCaseSensitive, isMatchWholeWordOnly, isFindFirstN, lastPageNumber, remainingGroupPaths, numberOfProcessedGroupPath) {
        ...
        var request = MochiKit.Base.bind(this._request, this, {'searchAll':encodeURIComponent(searchText), 'isNewSearch':isNewSearch, 'isMatchCase':isCaseSensitive , 
            ...
            'numberOfProcessedGroupPath':numberOfProcessedGroupPath }, true, false)
    ...
    _onSubmitPromptEnginePrompts: function(isFullPrompt) {
        ...
        if (!useAjax) {
            var parentObj = { layer : { offsetWidth : window.winWidth(), offsetHeight : window.winHeight() } };
            this._reportProcessing.setParent(parentObj);
        }
        
        this._request({'crprompt':'pmtEngine', 'isFullPrompt': isFullPrompt, "ValueID" : _valueId, "ContextHandleID" : _contextHandleId, "ContextID" : _contextId}, useAjax, true);
    ...
    setReportSource: function(reportIdType, reportId, boeLogonType, boeLogonString, locale) {
        ...
        if (arguments[0] instanceof SAP.CR.InProcReportSource) //InProc reportsource
        {
        	...
        	var reportId = inProcReportSourceVar.getReportId();
        	...
        	this._request({ setReportSource: 'InProc', reportId : reportId, ebisId : ebistId, 
