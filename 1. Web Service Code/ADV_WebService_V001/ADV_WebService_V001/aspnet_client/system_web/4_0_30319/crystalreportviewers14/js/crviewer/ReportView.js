...
bobj.crv.newReportView = function(kwArgs) {
    ...
    o.handlePageNavigationEvent = MochiKit.Base.partial(MochiKit.Signal.signal, o);
    MochiKit.Base.update(o, bobj.crv.ReportView);
    o._viewListener = new bobj.crv.ReportViewListener(o);
...
bobj.crv.ReportView = {
    ...
    focusFirstChild : function () {
        if(this.reportPage)
            return this.reportPage.focusFirstChild();
    ...
    addCanvasListener : function (listener) {
        if(this.reportPage)
            this.reportPage.addCanvasListener(listener);
    },
    
    removeCanvasListener : function (listener) {
        if(this.reportPage)
            this.reportPage.removeCanvasListener(listener);
    },
    
    getCanvasListeners : function () {
        if(this.reportPage)
            return this.reportPage.getCanvasListeners();
