...
var L_bobj_crv_Back = "Retroceder";
var L_bobj_crv_Forward = "Avanzar";
var L_bobj_crv_Page = "P\u00E1gina";
var L_bobj_crv_PageNum = "P\u00E1gina {0}";
...
var L_bobj_crv_InvalidPageNumber = "Especifique un n\u00FAmero de p\u00E1gina superior a 0.";
var L_bobj_crv_ParamPanel = "Panel de peticiones";
var L_bobj_crv_Parameters = "Par\u00E1metros";
var L_bobj_crv_GroupTree = "\u00C1rbol de grupos";
var L_bobj_crv_Search = "Buscar";
var L_bobj_crv_SearchResults = "Buscar resultados";
var L_bobj_crv_DrillUp = "Sintetizar";
var L_bobj_crv_DrillTo = "Explorar hasta %1";
...
var L_bobj_crv_SearchText = "Buscar";
var L_bobj_crv_SearchOptions = "Buscar opciones";
var L_bobj_crv_Export = "Exportar este informe";
var L_bobj_crv_Print = "Imprimir este informe";
var L_bobj_crv_History = "Historial";
var L_bobj_crv_ClearHistory = "Borrar historial";
var L_bobj_crv_TabList = "Lista de fichas";
var L_bobj_crv_Minimize = "Minimizar";
var L_bobj_crv_Logo=  "Logotipo de Business Objects";
var L_bobj_crv_FileMenu = "Men\u00FA de archivo";
var L_bobj_crv_ResultsFound = "{0} resultados encontrados";
var L_bobj_crv_MatchWholeWordsOnly = "Coincidir solo palabras completas";
var L_bobj_crv_MatchCase = "Coincidir may\u00FAsculas y min\u00FAsculas";
var L_bobj_crv_FindMore = "Buscar m\u00E1s";
var L_bobj_crv_Completed = "Completado";
var L_bobj_crv_Breadcrumb= "Rastro";
...
var L_bobj_crv_ResetTip = "Reiniciar valores de par\u00E1metros";
...
var L_bobj_crv_FlashRequired = "Este contenido requiere Adobe Flash Player 11 o superior. {0}Haga clic aqu\u00ED para instalarlo.";
...
var L_bobj_crv_LastRefreshed = "\u00DAltima actualizaci\u00F3n: {0}";

var L_bobj_crv_Collapse = "Contraer";

var L_bobj_crv_CatalystTip = "Recursos en l\u00EDnea";
var L_bobj_crv_LoadingPage = "Cargando p\u00E1gina {0}...";
var L_bobj_crv_TakeActionMenuTip = "Seleccione una acci\u00F3n enlazada";
var L_bobj_crv_TakeActionExecuteActionError = "Ha surgido un problema al ejecutar la acci\u00F3n; contacte con su administrador.";
...
var L_bobj_crv_TakeActionNoActionsMenuLabel = "(No hay acciones disponibles)";

var L_bobj_crv_API_InvalidArray = "\'{0}\' es de tipo matriz";
var L_bobj_crv_API_InvalidBoolean = "\'{0}\' es de tipo booleano";
var L_bobj_crv_API_InvalidPageNumber = "\'pageNumber\' es de tipo entero y mayor que 0";
var L_bobj_crv_API_InstantiationFailed = "Debe crearse una instancia nueva de {0}.";
var L_bobj_crv_API_InvalidParamValue = "El valor del campo de par\u00E1metro \'{0}\' no es v\u00E1lido.";
var L_bobj_crv_API_InvalidParamType = "El tipo de campo de par\u00E1metro \'{0}\' no es v\u00E1lido. Seleccione un tipo v\u00E1lido en SAP.CR.Parameter.DataTypes";
var L_bobj_crv_API_InvalidParamName = "El nombre del campo de par\u00E1metro debe ser una cadena de una longitud superior a 0.";

var L_bobj_crv_API_InvalidNumOfArguments = "{0} requiere {1} argumento(s).";
var L_bobj_crv_API_InvalidValueType = "El tipo de valor previsto para este par\u00E1metro es \'{0}\'.";
var L_bobj_crv_API_InvalidCanvasListener= "La escucha debe ser una instancia de SAP.CR.Viewer.CanvasListener";
var L_bobj_crv_API_InvalidActionListener= "La escucha debe ser una instancia de SAP.CR.Viewer.ActionListener";
var L_bobj_crv_API_ValueTypeUndefined= "La propiedad paramType del campo de par\u00E1metro no es v\u00E1lido. S\u00F3lo se admiten valores de SAP.CR.Parameter.DataTypes.*.";
var L_bobj_crv_API_InvalidRangeBound = "Los enlaces superior e inferior solo pueden usar valores de SAP.CR.Parameter.RangeBoundTypes";
var L_bobj_crv_API_InvalidBeginValue = "El valor inicial no es v\u00E1lido";
var L_bobj_crv_API_InvalidEndValue = "El valor final no es v\u00E1lido";
var L_bobj_crv_API_RangeBeginValueGreaterThanEndValue = "El valor inicial debe ser inferior o igual al valor final";
var L_bobj_crv_API_InvalidLowerAndUpperRangeBound = "Los valores de los enlaces superior e inferior no pueden ser iguales a SAP.CR.Parameter.DataTypes.UNBOUNDED";
var L_bobj_crv_API_InvalidBeginAndEndValue = "Los valores de inicio y fin no pueden ser iguales.";
var L_bobj_crv_API_InvalidColor = "El color \'{0}\' no es v\u00E1lido.";
var L_bobj_crv_API_InvalidResolution = "La resoluci\u00F3n {0} no es v\u00E1lida";
var L_bobj_crv_API_InvalidEventName = "\'{0}\' no es un evento v\u00E1lido. Elija un evento de {1}";
var L_bobj_crv_API_InvalidViewerName = "El nombre del visor \'{0}\' es incorrecto. Debe empezar con una letra y puede estar seguido de cualquier n\u00FAmero de letras o d\u00EDgitos.";
var L_bobj_crv_API_ViewerInitFailed = "Error al inicializar el visor";
var L_bobj_crv_API_ViewerLoadFailed = "Error al cargar el visor";

var L_bobj_crv_API_InvalidPrintMode = "\'{0}\' no es un modo de impresi\u00F3n v\u00E1lido. Elija un modo de impresi\u00F3n de {1}";
var L_bobj_crv_API_InvalidReportMode = "{0} no es un modo v\u00E1lido de informe. Seleccione un modo de informe de {1}";
var L_bobj_crv_API_InvalidZoom = "\'{0}\' no es un nivel de zoom v\u00E1lido";
var L_bobj_crv_API_InvalidFunction = "El primer argumento debe ser una funci\u00F3n";
var L_bobj_crv_API_InvalidFunctionAfterInit = "\'{0}\' no se puede llamar despu\u00E9s de haber inicializado el servidor.";
