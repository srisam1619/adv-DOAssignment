...
bobj.crv.params.TextCombo = {
    ...
    _createArrow : function() {
        var tooltip = L_DHTMLLIB_openMenu.replace("{0}", this.tooltip? this.tooltip: '');
    ...
    _createTextField : function() {
        this.text = bobj.crv.params.newTextField ( {
            ...
            blurCB : this.blurCB,
            clickCB : this.editable ? null : bobj.bindFunctionToObject (this.toggleMenu, this),
    ...
    getHTML : function() {
        ...
        var html = h.DIV ( {
            ...
            'class' : (bobj.crv.config.isRTL ? 'iactTextComboTextFieldRTL' : 'iactTextComboTextField')
