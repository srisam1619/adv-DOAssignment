...
var _boAllTabs= new Array();
    //
var _vertTabImgW=3;
    
var _vertTabLBorderToTxt=20-_vertTabImgW-1;
var _vertTabLBorderToIcon=12-_vertTabImgW-1;
var _vertTabIconToTxt=8;
var _vertTabIconSize=16;    //icon:16px x 16px
...
var _VertTab=2;                 //vertical navigation panel without icon
var _VertTabWithIcon=3;         //vertical navigation panel with icon
var _HorizTabTop=4;             //horizontal navigation bar on top 
var _HorizTabBottom=5;          //horizontal navigation bar at bottom
var _HorizTabTopWithClose=6;
var _menuBarTab=7;              //menu bar 
    
    //menu.png: 4 menu states for vertical navigation panel
var _vertTabHover=0;
var _vertTabSelected=1;
var _vertTabPressed=2;
var _vertTabNormal=3;
    
var _vertTabCSS=[   ['menuLeftMostSel', 'naviVTabLSelected', 'naviVTabLPressed', 'naviVTabNormal'], //left
...
var _vertNaviPanelMinW=120
var _vertNaviPanelMaxW=180
var _vertNaviPanelWithIconW=150
    
var _vertNaviPanelH=23*8    //8 links x 23px
    
var _naviHorzTabH=24;
    
    //used in _horizTabCSS & _horizBottomTabCSS
var _horizTabSelected=0;
var _horizTabNormal=1;
var _horizTabHover=2;   //hover on no selected
var _horizTabSelHover=3;//hover on selected
var _horizTabPressed=4;
    

    
    //tab list icon state in horizontal bar used in _horizTabCSS & _horizBottomTabCSS
var _tabListNormal=0;
var _tabListHover=1;
var _tabListPressed=2;
    
    //horizontal bar at top
var _horizTabCSS=[  ['naviHTabLSelected', 'naviHTabLNormal', 'naviHTabLHover', 'naviHTabLSelHover', 'naviHTabLNormal'], //left
...
var _horizTabImgL=4;
var _horizTabImgR=23;
    
var _horizTabTxtPaddingL=15;
var _horizTabTxtPaddingR=3;
var _horizTabTxtPaddingB=5;
    
var _horizTabImgPadL=8;
var _horizTabImgToTxt=6;
    
var _horizBottomTabTxtPadB=7;
    
    //for close icon
var _horizTabTxtToClose=5;
var _horizTabClosePadR=1;
    
    //scroll bar in horizontal navigation bar
var _noScrollBar=0;
var _ScrollBarAtBegin=1;
var _ScrollBarAtEnd=2;
                       
    
var _horizBarWidth=100  //not include scroll bar
    
    //menu bar's height is the same as that of the tool bar
var _defaultMenuBarWidth=200;
var _menuBarTabHeight=22;
    

    //tab list icon for horizontal bar
var _tabListIconWidth=19;
...
// Return   : The new object
{
    ...
    o.getNewRowBelowTabBar=TabbedZoneWidget_getNewRowBelowTabBar
...
//return void
{
    ...
    var rightFrame = getLayer(o.id+'_rightFrame');
    if (rightFrame)
    {
        if(o.h)
            rightFrame.style.height = o.h + 'px';
    }
    var leftFrame = getLayer(o.id+'_leftFrame');
    if (leftFrame)
    {
        if(o.h)
            leftFrame.style.height = o.h + 'px';
    }
}
...
function TabbedZoneWidget_getNewRowBelowTabBar()
{
    return '';
}
...
{
    var o=this;
    var frameSize = _ie && _isQuirksMode ? '5px' : '4px';
    return '<table id="'+this.id+'" cellspacing="0" cellpadding="0" border="0" style="position:absolute;"><tbody><tr class="hideableFrame" valign="bottom" height="23">'+
    '<td>&nbsp;</td>'+
    '<td valign="top" align="left">'+o.tabs.getHTML()+'</td>'+
    '<td>&nbsp;</td></tr>'
    +this.getNewRowBelowTabBar()
    +'<tr>'
      +'<td><div class="tabbedFrame tabbedFrameCorner ' + (_rtl ? 'tabbedFrameTopRight' : 'tabbedFrameTopLeft') + '" style="'+sty('width',frameSize)+sty('height',frameSize)+'"/></td>'
      +'<td><div class="tabbedFrame tabbedFrameTop" style="'+sty('height',frameSize)+'"/></td>'
      +'<td><div class="tabbedFrame tabbedFrameCorner ' + (_rtl ? 'tabbedFrameTopLeft' : 'tabbedFrameTopRight') + '" style="'+sty('width',frameSize)+sty('height',frameSize)+'"/></td>'
    +'</tr>'
    +'<tr>'
      +'<td class="hideableFrame"><div id="'+o.id+'_leftFrame" class="tabbedFrame ' + (_rtl ? 'tabbedFrameRight' : 'tabbedFrameLeft') + '" style="'+sty('width',frameSize)+'"/></td>'
      +'<td class="dialogzone"><div id="'+o.id+'_container'+'" style="'+sty("width",o.w)+sty("height",o.h)+'">';
}
...
function TabbedZoneWidget_endHTML()
{
    var o=this;
    var frameSize = _ie && _isQuirksMode ? '5px' : '4px';
    return '</div><td class="hideableFrame"><div id="'+o.id+'_rightFrame" class="tabbedFrame ' + (_rtl ? 'tabbedFrameLeft' : 'tabbedFrameRight') + '" style="'+sty('width',frameSize)+'"/></td></tr>' +
                '<tr class="hideableFrame">' +
                '<td><div class="tabbedFrame tabbedFrameCorner ' + (_rtl ? 'tabbedFrameBottomRight' : 'tabbedFrameBottomLeft') + '" style="'+sty('width',frameSize)+sty('height',frameSize)+'"/></td>' +
                '<td><div class="tabbedFrame tabbedFrameBottom" style="'+sty('height',frameSize)+'"/></td>' +
                '<td><div class="tabbedFrame tabbedFrameCorner ' + (_rtl ? 'tabbedFrameBottomLeft' : 'tabbedFrameBottomRight') + '" style="'+sty('width',frameSize)+sty('height',frameSize)+'"/></td></tr>'+
                '</tr></tbody></table>';
}
...
function NaviTabWidget_getHorizHTML()
{
    ...
    if (o.hasCloseButton())
    {
        ...
        s+='<div tabindex="0" class="naviHTabCloseSel" id="'+o.closeid+'" role="button" title="'+L_DHTMLLIB_closeTab+' '+convStr(o.name)+'"></div></td>';
    }
