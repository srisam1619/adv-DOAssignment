...
var L_bobj_crv_Back = "Siirry takaisin";
var L_bobj_crv_Forward = "Siirry eteenp\u00E4in";
var L_bobj_crv_Page = "Sivu";
var L_bobj_crv_PageNum = "Sivu {0}";
...
var L_bobj_crv_InvalidPageNumber = "M\u00E4\u00E4rit\u00E4 sivunumero, joka on suurempi kuin 0.";
var L_bobj_crv_ParamPanel = "Kehotepaneeli";
var L_bobj_crv_Parameters = "Parametrit";
var L_bobj_crv_GroupTree = "Ryhm\u00E4rakenne";
var L_bobj_crv_Search = "Hae";
var L_bobj_crv_SearchResults = "Hakutulokset";
var L_bobj_crv_DrillUp = "Siirry yl\u00F6s";
var L_bobj_crv_DrillTo = "Siirry kohteeseen %1";
...
var L_bobj_crv_SearchText = "Hae";
var L_bobj_crv_SearchOptions = "Hakuasetukset";
var L_bobj_crv_Export = "Vie t\u00E4m\u00E4 raportti";
var L_bobj_crv_Print = "Tulosta t\u00E4m\u00E4 raportti";
var L_bobj_crv_History = "Historia";
var L_bobj_crv_ClearHistory = "Tyhjenn\u00E4 historia";
var L_bobj_crv_TabList = "V\u00E4lilehtiluettelo";
var L_bobj_crv_Minimize = "Pienenn\u00E4";
var L_bobj_crv_Logo=  "Business Objects -logo";
var L_bobj_crv_FileMenu = "Tiedosto-valikko";
var L_bobj_crv_ResultsFound = "{0} tulosta l\u00F6ydettiin";
var L_bobj_crv_MatchWholeWordsOnly = "Koko sana";
var L_bobj_crv_MatchCase = "Sama kirjainkoko";
var L_bobj_crv_FindMore = "Etsi lis\u00E4\u00E4";
var L_bobj_crv_Completed = "Valmis";
var L_bobj_crv_Breadcrumb= "Navigointipolku";
...
var L_bobj_crv_ParamsCalBtn = "Kalenteri";
var L_bobj_crv_Reset= "Palauta";
var L_bobj_crv_ResetTip = "Palauta parametriarvot";
...
var L_bobj_crv_paramsOpenAdvance = "Tarkennettu kehote -painike kohteelle \'%1\'";
...
var L_bobj_crv_FlashRequired = "T\u00E4m\u00E4 sis\u00E4lt\u00F6 vaatii Adobe Flash Player 11 -ohjelmiston tai sen uudemman version. {0}Asenna napsauttamalla t\u00E4t\u00E4.";
var L_bobj_crv_ReadOnlyInPanel= "T\u00E4m\u00E4 parametri ei ole muokattavissa paneelissa. Muokkaa parametrin arvoa avaamalla Tarkennettu kehote -valintaikkuna";
...
var L_bobj_crv_AdvancedDialog_NoAjax= "Katseluohjelma ei voi avata Tarkennettu kehote -valintaikkunaa.";

var L_bobj_crv_EnableAjax= "Ota yhteys j\u00E4rjestelm\u00E4nvalvojaan, jotta voit ottaa k\u00E4ytt\u00F6\u00F6n asynkroniset pyynn\u00F6t.";

var L_bobj_crv_LastRefreshed = "Viimeksi p\u00E4ivitetty: {0}";

var L_bobj_crv_Collapse = "Tiivist\u00E4";

var L_bobj_crv_CatalystTip = "Online-resurssit";
var L_bobj_crv_LoadingPage = "Ladataan sivua {0}...";
var L_bobj_crv_TakeActionMenuTip = "Valitse sidottu toiminto";
var L_bobj_crv_TakeActionExecuteActionError = "Toiminnon suorituksessa ilmeni ongelma. Ota yhteys j\u00E4rjestelm\u00E4nvalvojaan.";
...
var L_bobj_crv_TakeActionNoActionsMenuLabel = "(Toimintoja ei ole k\u00E4ytett\u00E4viss\u00E4)";

var L_bobj_crv_API_InvalidArray = "\"{0}\" n tyyppi\u00E4 Taulukko";
var L_bobj_crv_API_InvalidBoolean = "\"{0}\" on tyyppi\u00E4 Totuusarvo";
var L_bobj_crv_API_InvalidPageNumber = "\'pageNumber\' on Integer-tyyppi\u00E4 ja suurempi kuin 0";
var L_bobj_crv_API_InstantiationFailed = "{0}: uusi ilmentym\u00E4 on luotava.";
var L_bobj_crv_API_InvalidParamValue = "Parametrikent\u00E4n \'{0}\' arvo ei kelpaa.";
var L_bobj_crv_API_InvalidParamType = "Parametrikent\u00E4n \'{0}\' tyyppi ei kelpaa. Valitse kelvollinen tyyppi SAP.CR.Parameter.DataTypes-kohteesta";
var L_bobj_crv_API_InvalidParamName = "Parametrikent\u00E4n nimen on oltava merkkijono, jonka pituus on nollaa suurempi.";

var L_bobj_crv_API_InvalidNumOfArguments = "{0} edellytt\u00E4\u00E4 {1} argumenttia.";
var L_bobj_crv_API_InvalidValueType = "T\u00E4m\u00E4n parametrin odotettu arvotyyppi on \"{0}\".";
var L_bobj_crv_API_InvalidCanvasListener= "Kuuntelijan on oltava kohteen SAP.CR.Viewer.CanvasListener esiintym\u00E4";
var L_bobj_crv_API_InvalidActionListener= "Kuuntelijan on oltava kohteen SAP.CR.Viewer.ActionListener esiintym\u00E4";
var L_bobj_crv_API_ValueTypeUndefined= "Parametrikent\u00E4n paramType-ominaisuus on virheellinen. Vain SAP.CR.Parameter.DataTypes.*-arvot ovat tuettuja.";
var L_bobj_crv_API_InvalidRangeBound = "Yl\u00E4- ja alarajassa voi k\u00E4ytt\u00E4\u00E4 vain SAP.CR.Parameter.RangeBoundTypes-arvoja";
var L_bobj_crv_API_InvalidBeginValue = "Alkuarvo ei kelpaa";
var L_bobj_crv_API_InvalidEndValue = "Loppuarvo ei kelpaa";
var L_bobj_crv_API_RangeBeginValueGreaterThanEndValue = "Alkuarvon on oltava pienempi tai yht\u00E4 suuri kuin loppuarvon";
var L_bobj_crv_API_InvalidLowerAndUpperRangeBound = "Sek\u00E4 ala- ett\u00E4 yl\u00E4rajan arvo ei voi olla sama kuin SAP.CR.Parameter.DataTypes.UNBOUNDED";
var L_bobj_crv_API_InvalidBeginAndEndValue = "Alku- ja loppuarvo eiv\u00E4t voi olla samat.";
var L_bobj_crv_API_InvalidColor = "V\u00E4ri \'{0}\' ei kelpaa.";
var L_bobj_crv_API_InvalidResolution = "Tarkkuus {0} ei ole kelvollinen";
var L_bobj_crv_API_InvalidEventName = "\'{0}\' ei ole kelvollinen tapahtuma. Valitse tapahtuma kohteesta {1}";
var L_bobj_crv_API_InvalidViewerName = "Katseluohjelman nimi \'{0}\' on virheellinen. Nimen t\u00E4ytyy alkaa kirjaimella, jonka j\u00E4lkeen voi tulla mik\u00E4 tahansa m\u00E4\u00E4r\u00E4 kirjaimia ja numeroita.";
var L_bobj_crv_API_ViewerInitFailed = "Katseluohjelman alustus ep\u00E4onnistui";
var L_bobj_crv_API_ViewerLoadFailed = "Katseluohjelman lataus ep\u00E4onnistui";

var L_bobj_crv_API_InvalidPrintMode = "\'{0}\' ei ole kelvollinen tulostustila. Valitse tulostustila kohteesta {1}";
var L_bobj_crv_API_InvalidReportMode = "\'{0}\' ei ole kelvollinen raporttitila. Valitse raporttitila kohteesta {1}";
var L_bobj_crv_API_InvalidZoom = "\'{0}\' ei ole kelvollinen zoomaustaso";
var L_bobj_crv_API_InvalidFunction = "Ensimm\u00E4isen argumentin tulee olla funktio";
var L_bobj_crv_API_InvalidFunctionAfterInit = "Kohdetta \'{0}\' ei voi kutsua katseluohjelman alustuksen j\u00E4lkeen.";
// <script>
/*
=============================================================
...
L_DHTMLLIB_month[0]="TAMMIKUU";
L_DHTMLLIB_month[1]="HELMIKUU";
L_DHTMLLIB_month[2]="MAALISKUU";
L_DHTMLLIB_month[3]="HUHTIKUU";
L_DHTMLLIB_month[4]="TOUKOKUU";
L_DHTMLLIB_month[5]="KESÄKUU";
L_DHTMLLIB_month[6]="HEINÄKUU";
L_DHTMLLIB_month[7]="ELOKUU";
L_DHTMLLIB_month[8]="SYYSKUU";
L_DHTMLLIB_month[9]="LOKAKUU";
L_DHTMLLIB_month[10]="MARRASKUU";
L_DHTMLLIB_month[11]="JOULUKUU";

L_DHTMLLIB_closeDialog="Sulje ikkuna";

L_DHTMLLIB_openMenu="Käytä asetuksia {0} napsauttamalla tätä";

L_DHTMLLIB_expandedLab="Laajennettu";
L_DHTMLLIB_collapsedLab="Tiivistetty";
L_DHTMLLIB_selectedLab="Valittu";

L_DHTMLLIB_calendarNextMonthLab="Siirry seuraavaan kuukauteen";
L_DHTMLLIB_calendarPrevMonthLab="Siirry edelliseen kuukauteen";
L_DHTMLLIB_calendarNextYearLab="Siirry seuraavaan vuoteen";
L_DHTMLLIB_calendarPrevYearLab="Siirry edelliseen vuoteen";
L_DHTMLLIB_calendarSelectionLab="Valittu päivä";

L_DHTMLLIB_menuCheckLab="Valittu";
L_DHTMLLIB_menuDisableLab="Poistettu käytöstä";
	
L_DHTMLLIB_level="Taso";
L_DHTMLLIB_closeTab="Sulje välilehti";
L_DHTMLLIB_of=" / ";

L_DHTMLLIB_helpLab="Ohje";

L_DHTMLLIB_cancelButtonLab="Peruuta";
