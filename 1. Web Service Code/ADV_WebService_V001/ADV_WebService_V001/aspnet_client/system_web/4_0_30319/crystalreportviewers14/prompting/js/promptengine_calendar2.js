...
bobj.prompt.Calendar = function(formName,dateFormat,locale,promptJsFilePrefix, bIsRTL) {
    this.locale = locale;
    ...
    bobj.prompt.isRTL = bIsRTL; // bobj.crv.Calendar refer to this for RTL in the CAF workflow
}
