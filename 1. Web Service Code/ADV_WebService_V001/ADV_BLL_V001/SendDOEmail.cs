...
namespace ADV_BLL_V001
{
    public class SendDOEmail
    {
        ...
        public long SendEmail(DataTable dt, string sEmailTo, string ServiceCallId, string DONumber, long ReturnNoteNo, ref string sErrDesc)
        {
            ...
            try
            {
                ...
                MailMessage message = CreateDefaultMailMessage(dt, sFromMailId, sSendTo, sCC, ServiceCallId, DONumber, ReturnNoteNo, ref sErrDesc);
        ...
        private MailMessage CreateDefaultMailMessage(DataTable dt, string MailFrom, string[] MailTo, string[] CC, string ServiceCallId, string DONumber, long ReturnNoteNo, ref string sErrDesc)
        {
            ...
            try
            {
                ...
                message.Subject = "Cancellation - " + ServiceCallId + " - " + DONumber + ".";
                message.BodyEncoding = System.Text.Encoding.UTF8;
                message.Body = ComposeBody(dt, DONumber, ReturnNoteNo);
        ...
        public string ComposeBody(DataTable dtBody, string sDONumber, long ReturnNoteNo)
        {
            ...
            {
                sBodyDetail = "<tr><td> &nbsp;" + sDONumber + "</td><td>&nbsp;" + Convert.ToString(ReturnNoteNo) + "</td><td>&nbsp;" + item["ItemCode"].ToString() + " </td> " +
            ...
            string stextBody = "<p style='font-size:10.0pt;font-family:Arial;'>Dear All,<br /><br /> Please take note that the following item has been cancelled due to the following reasons. " +
                                ".<br/><br /> " + sTableFormat + "<br/> <b> Please double check on SAP system and close off your case. </b> <br/><b> Thank you. </b>" +
